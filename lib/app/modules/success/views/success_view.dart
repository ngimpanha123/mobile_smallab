...
class SuccessView extends StatelessWidget {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Icon(Icons.check, size: AppWidgetSize.iconXL, color: Colors.white),
            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _infoRow("Receipt Number", "#$receipt"),

                  SizedBox(height: AppSpacing.marginSmall),

                  _infoRow("Ordered At", orderedAt.replaceAll("T", " ").replaceAll("Z", "")),
            ...
            Row(
              ...
              children: [
                _actionButton(Icons.print, () {}),
                SizedBox(width: AppSpacing.marginLarge),
                _actionButton(Icons.download, () {}),
                SizedBox(width: AppSpacing.marginLarge),
  ...
  /// Simple version if only a string receipt is passed
